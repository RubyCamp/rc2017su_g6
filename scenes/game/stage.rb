...
STAGE_A = [
 ...
 STAGE_B = [
  ...
  # [0,     480, 3073, 100],				                  # 地面
  [10,    400,  500,  Window.height-400],		  # 510
  [650,   400,  100,  Window.height-400],		# 750
  [800,   350,  30,   Window.height-350],		  # 830
  [890,   300,  40,   Window.height-300],		            # 空中
  [1000,  400,  200,  Window.height-400],	  # 1200
  [1130,  340,  40,   40],			                    # 空中
  [1260,  430,  90,   Window.height-430],		# 1350
  [1400,  350,  50,   Window.height-350],		# 1450
  [1530,  400,  100,  Window.height-400],		# 1630
  [1700,  0,    70,   300],			            # 1770	# 挟む上
  [1700,  335,  100,  Window.height-335],		# 1880	# 挟む下
  [1900,  300,  100,  Window.height-300],		# 2000
  [1970,  0,    20,   200],			                     # 上
  [2050,  350,  50,   Window.height-350],		# 2100
  [2150,  270,  20,   Window.height-270],		# 2170
  [2300,  0,    50,   150],			            # 2350	# 挟む上
  [2250,  190,  100,  Window.height-185],		# 3350	# 挟む下
  [2390,  100,  40,   40],
  [2430,  200,  40,   40],
  [2625,  300,  40,   40],
  [2700,  0,    100,  150],				                # 挟む上
